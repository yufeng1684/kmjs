...
//        String originalFilename = file.getOriginalFilename();
        ...
        if (file != null && originalFilename != null && originalFilename.length() > 0) {
            ...
            //新的图片名称
            newFileName = "于峰" + originalFilename.substring(originalFilename.lastIndexOf("."));
        ...
        // 更新商品信息
        ProductBean productModel = productBeanMapper.selectByPrimaryKey(productId);
        if(null != productModel){
            ...
            productBeanMapper.updateByPrimaryKeySelective(productModel);
        }
        return "status";
    }
